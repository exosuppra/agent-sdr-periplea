...
def chat_reply(settings, profile: str, history: list, message: str, calendar=None, crm=None,
    ...
    if use_tools and calendar is not None:
        system += (
            ...
            "les creneaux libres renvoyes par l'outil ; "
            "(2bis) si le prospect evoque un JOUR precis (un mercredi, le 24, la semaine prochaine), appelle "
            "consulter_disponibilites avec ce moment AVANT de repondre, et ne declare JAMAIS qu'un jour entier "
            "est complet sans l'avoir verifie : l'outil remonte aussi les creneaux du jour ou du jour de semaine "
            "demande, propose-les ; "
